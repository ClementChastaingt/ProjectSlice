...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Parameters|WallRun|Jump", meta=(UIMin = 0.f, ClampMin = 0.f, ToolTip="WallRun jump off custom gravity scale for player "))
	float JumpOffGravityScale = 1.5f;
